...
Repositório de provas antigas da Disciplina **Matemática para Computação** do curso de **Tecnologia em Sistemas de Computaćao** da **UFF** ministrado através do **CEDERJ**.
...
`git clone https://github.com/compcederj/matematica-para-computacao.git`
...
`git clone git@github.com:compcederj/matematica-para-computacao.git`
...
# Matemática para Computação
Repositório de provas antingas da Disciplina **Matemática para Computação** do curso de **Tecnologia em Sistemas de Computaçao** da **UFF** ministrado através do **CEDERJ**.
